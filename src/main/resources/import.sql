...
INSERT INTO TBL_LIVROS(ID,DESTAQUE,FOTO,PAGINAS,PRECO,STATUS,TITULO,AUTOR_ID,CATEGORIA_ID,EDITORA_ID,DESCRICAO) VALUES (3,'true','imagens/o-poder-do-subconsciente.jpg',100,300.0,'true','O Poder Do Subconsciente',1,2,4,'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown');

INSERT INTO TBL_LIVROS(ID,DESTAQUE,FOTO,PAGINAS,PRECO,STATUS,TITULO,AUTOR_ID,CATEGORIA_ID,EDITORA_ID,DESCRICAO) VALUES (4,'true','imagens/Liberte-o-poder-do-seu-subconsciente.jpg',76,400.0,'true','Liberte O Poder Do Seu Subconsciente',4,2,1,'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown');

INSERT INTO TBL_LIVROS(ID,DESTAQUE,FOTO,PAGINAS,PRECO,STATUS,TITULO,AUTOR_ID,CATEGORIA_ID,EDITORA_ID,DESCRICAO) VALUES (5,'true','imagens/A-arte-de-conquistar-superpoderes-mentais.jpg',500,500.0,'true','A Arte De Conquistar Superpoderes Mentais',1,3,2,'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown');

INSERT INTO TBL_LIVROS(ID,DESTAQUE,FOTO,PAGINAS,PRECO,STATUS,TITULO,AUTOR_ID,CATEGORIA_ID,EDITORA_ID,DESCRICAO) VALUES (6,'true','imagens/Pichau_ (24).png',175,600.0,'true','mister musca',2,2,2,'Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs. The passage is attributed to an unknown');
