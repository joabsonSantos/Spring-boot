	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-md">
		...
		<div class="container">
			...
			<a class="navbar-brand" href="/"> <img alt="LOGO"
				src="/resources/img/pilha-livros.png" width="80em">
			</a>
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="/admin/livros">Editar Livros</a> <a
								class="dropdown-item" href="/admin/categorias">Editar
								Categorias</a> <a class="dropdown-item" href="/admin/autores">Editar
								Autores</a> <a class="dropdown-item" href="/admin/editoras">Editar
								Editoras</a>
						</div></li>
				</ul>
			</div>
