	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-md">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbar">
				...
				<div class="container my-2 d-block" style="width: 27em">

					<form:form action="${s:mvcUrl('IC#filtrarTitulo').build()}" method="POST" modelAttribute="livro" class="d-flex">
						<form:input class="form-control me-2 mr-1" path="titulo" type="search" placeholder="Pesquisar" aria-label="pesquisar"/>
